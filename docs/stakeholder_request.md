...
+ [4.4.Робоче місце Лідера проекту](#4-4)
...
### <p id="4-4">4.4.Робоче місце Лідера проекту</p>
#### Підбирати учасників проекту
В залежності від поставленої замовником головної мети проекту, існують проміжні задачі для досягнення головної мети проекту. Лідер проекту з працівників компанії підбирає учасників проекту, для реалізації окремих завданнь та проекту в цілому відповідно до їх навичок
