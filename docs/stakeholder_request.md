...
Процеси взагалі - це систематичне, послідовне визначення функціональних операцій, які приносять специфічний результат; це послідовність пов'язаних операцій або завдань, що потрібні для досягнення результату.
 ...
 Власник організації має посаду та права адміністратору всередині нашої програми, створює новий проект. Встановлює головну мету даного проекту, та етапи досягнення цієї цілі. Додає в проект користувачів та специфіка роботи яких підходить для цього проекту. Адміністратор ставить перед кожним учасником проекту певні задачі, які мають бути виконані, та чергу їх виконання, так вказую DeadLine конкретних завдань та всього проект загалом.
  ...
  Інформація в сучасному світі є найціннішим ресурсом, тому ми повністю запевняємо, що вся інформаціє про організацію та особисті данні користувачів не вийдуть за межі нашого продукту та будуть зберігатись у зашифрованому вигляді. 
